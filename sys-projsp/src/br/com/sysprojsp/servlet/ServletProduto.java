...
import br.com.sysprojsp.classes.model.Produto;
import br.com.sysprojsp.dao.ProdutoDao;

@WebServlet("/pages/servletProduto")
public class ServletProduto extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/pages/cadastroprodutos.jsp");
