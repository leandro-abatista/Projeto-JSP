...
import br.com.sysprojsp.classes.model.Categoria;
import br.com.sysprojsp.dao.CategoriaDao;

@WebServlet("/pages/servletCategoria")
...
private static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (acao.equalsIgnoreCase("delete")) {
			...
			RequestDispatcher view = request.getRequestDispatcher("/pages/cadastrocategorias.jsp");
