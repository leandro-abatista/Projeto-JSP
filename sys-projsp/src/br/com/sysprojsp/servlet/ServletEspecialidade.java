...
import br.com.sysprojsp.dao.EspecialidadeDao;

@WebServlet("/pages/servletEspecialidade")
public class ServletEspecialidade extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (acao.equalsIgnoreCase("delete")) {
			...
			RequestDispatcher view = request.getRequestDispatcher("/pages/cadastroespecialidades.jsp");
