...
import br.com.sysprojsp.classes.model.Bandeira;
import br.com.sysprojsp.dao.DaoBandeira;

/**
 * Servlet implementation class ServletBandeira
 */
@WebServlet("/pages/servletBandeira")
public class ServletBandeira extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/pages/cadastrobandeiras.jsp");
